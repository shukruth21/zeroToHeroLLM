...
class Solution:
    def reshape(self, to_reshape: TensorType[float]) -> TensorType[float]:
        ...
        return torch.round(torch.reshape(to_reshape,(-1,2)),decimals=4)#if we specify the columns based on the data pytorch will automatically find the number of rows
